...
- [1. What the Evidence Actually Tells Us](#1-what-the-evidence-actually-tells-us)
- [2. Competency Framework](#2-competency-framework)
- [3. The Five-Day Course](#3-the-five-day-course)
- [4. What's Deliberately Not Being Taught](#4-whats-deliberately-not-being-taught)
- [5. Assessment: Measuring Capability, Not Confidence](#5-assessment-measuring-capability-not-confidence)
- [6. The 90 Days After the Course](#6-the-90-days-after-the-course--where-capability-actually-gets-decided)
- [Closing](#closing)
- [Annex A: Competency Framework in Full](#annex-a-competency-framework-in-full)
- [Annex B: Ninety-Minute Session](#annex-b-ninety-minute-session-ready-for-someone-else-to-deliver)
- [Annex C: Pre- and Post-Course Instrument](#annex-c-pre--and-post-course-instrument)
...
Six domains (data acquisition, data management/documentation, analysis, cartography, QA/governance, knowledge sharing) are scored against this ladder — see [Annex A](#annex-a-competency-framework-in-full) for the full matrix. Progression requires evidence from **three separate pieces of work**, not one good day — this stops a single strong submission from inflating a competency record that a manager will later rely on for a staffing decision.
...
- Full item wording and rubric: [Annex C](#annex-c-pre--and-post-course-instrument)
- Ready-to-deliver 90-minute session on the weakest domain (reproducible cleaning): [Annex B](#annex-b-ninety-minute-session-ready-for-someone-else-to-deliver)
...
1. **Fix the software constraint first** *(before Day 1, non-negotiable)*. QGIS LTR — free, no licensing barrier — installed and tested on every workstation, a named IT contact, a shared data folder. If this slips, the course slips.
2. **Days 1–30 — real work, not more exercises.** Each officer completes ≥2 genuine departmental assignments using the standard templates; every submission arrives with its workflow log, metadata, QA check and supervisor sign-off.
3. **Days 31–60 — structured transfer.** Fortnightly mentoring pairs, a monthly problem clinic, peer review against the same QA checklist used in training.
4. **Days 61–90 — independent delivery + feedback loop.** A short lessons-learned session updates the SOPs — the department's documentation improves because the course ran, not just the people.
...
Six domains, each scored against the four-level ladder in [Section 2](#2-competency-framework). Moving up a level requires evidence from at least three separate pieces of work.
...
**Session:** Building a reproducible data-cleaning workflow
**Duration:** 90 min
**Domain:** Data management and documentation
**Target:** Level 2, Supported Practitioner
